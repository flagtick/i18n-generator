...
In your project:
```composer require flagtick/i18n-generator --dev```
...
```php
FlagtickGroup\InternationalizationGenerator\GeneratorProvider::class,
```

Next, publish the package default config:

```
php artisan vendor:publish --provider="FlagtickGroup\InternationalizationGenerator\GeneratorProvider"
```
